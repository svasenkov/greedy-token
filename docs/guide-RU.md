> **Справка.** Короткая человеческая витрина — в [README-RU.md](../README-RU.md). Ниже — подробный guide (CLI, MCP, конфиг, тесты).
...
**Модель в долларах (иллюстрация, USD / месяц):** mid-intensity смесь **CLI / pipeline / crystallize** vs классический базлайн. Строки tool→cursor — классы работы; ★ ИТОГО (**★ $82** / **★ $820**) — **headline для этой смеси**, не измеренная экономия MCP-чата. В Cursor MCP host-модель уже отработала. Ollama ≈ **$8 / машина / мес** (или **$25** за общий сервер на ×10). Строка `rag` — **lexical docs search**, не vector RAG.
...
| **rag** (lexical docs) | Ответ в `docs/rag/` через overlap-поиск | Недокументированный код / semantic recall | $0 | $15 | $15 | $0 (общие docs) | $150 | $150 | `какой -D flag для baseUrl` |
...
| **★ ИТОГО с greedy-token** | Иллюстрация CLI/pipeline mix vs naive | — | **$48** | **$130** | **★ $82** | **$425** | **$1,300** | **★ $820** | **не экономия MCP-чата** |
