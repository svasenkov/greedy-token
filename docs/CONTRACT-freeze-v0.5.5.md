# CONTRACT freeze — greedy-token v0.5.5

**Root:** `projects/greedy-token-home/greedy-token/`  
**TARGET:** `0.5.5` (tag `v0.5.5`)  
**Frozen:** 2026-07-10
...
| ID | Claim | SSOT |
|----|-------|------|
| V1 | Version **0.5.5** everywhere | `pyproject.toml`, `__init__.py`, README scope |
...
## Accepted backlog (not v0.5.5 blockers)

- B1: `SearchResult.spent_tokens` unused field
- B2: MCP stdio `pipeline execute=true` e2e gap
