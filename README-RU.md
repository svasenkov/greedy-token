...
Иллюстрация, USD / месяц **и** wall-clock на вызов. **Классическая LLM** = всё сразу в облачный / frontier-чат. Первый подходящий tier побеждает. Время — оценка vs наивный агент-ход (`time_saved_ms` в MCP footer / `report`, v0.11+).

| Путь | Когда | Не для | Путь · 1 инж. | Классич. · 1 инж. | Экономия · 1 | Путь · ×10 | Классич. · ×10 | Экономия · ×10 | ~время (путь / агент) | Пример |
|------|-------|--------|---------------|-------------------|--------------|------------|----------------|----------------|----------------------|--------|
| **tool** (rg) | найти текст в репо | правки / дизайн | $0 | $30 | $30 | $0 | $300 | $300 | ~1s / ~20s | `find baseUrl in configurator-option-presets.html` |
| **python** | уже есть детерминированный скрипт | «почини всё» / архитектура | $0 | $25 | $25 | $0 | $250 | $250 | ~1s / ~20s | `meta-audit configurator-boolean` |
| **rag** | ответ в паттернах / docs | недокументированный код | $0 | $15 | $15 | $0 | $150 | $150 | ~0.5s / ~15s | какой `-D` flag для baseUrl |
| **ollama** | bulk classify / лёгкий audit | точный wiring | $8 | $20 | $12 | $25 | $200 | $175 | ~5s / ~25s | классифицировать пачку skills |
| **cursor** | wiring, рефакторинг, суждение | grep / bulk-copy | $40 | $40 | $0 | $400 | $400 | $0 | ~same | поменять поведение header в одной зоне |
| **классич. LLM** | база: всё в большую модель | — | $130 | $130 | — | $1,300 | $1,300 | — | ~same | кинуть в чат целую папку |
| **★ ИТОГО** | с роутером vs без | — | **$48** | **$130** | **★ $82** | **$425** | **$1,300** | **★ $820** | **★ ~6 ч / ~60 ч · мес** | **главные цифры: $ и время / месяц** |
