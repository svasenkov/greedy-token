...
@allure.title("WRAPPERS registry includes read-only check-meta-sync")
...
@allure.title("resolve_wrapper_command builds shell script invocation")
...
@allure.story("Command resolution")
@allure.title("resolve_wrapper_command raises for unknown wrapper id")
...
@allure.title("ollama_available returns true when /api/tags responds")
...
@allure.story("Ollama probe")
@allure.title("ollama_available returns false when server is down")
